...
class BookingDetails(BaseModel):
	date: str | None = Field(None, description="Real booking date in DD-MM-YYYY format within the next 14 days.", example="25-12-2024")
	time: str | None = Field(None, description="Real booking time in HH:MM format between 12:00 and 22:00.", example="19:30")
